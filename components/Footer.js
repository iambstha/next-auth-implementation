...
const Footer = () => {
  return (
    <div className=' p-8 flex flex-col flex-wrap justify-center items-center border-t mt-4 md:mt-8 '>
        <p>Created by: <Link target='_blank' href='http://bishal-shrestha.com.np/' className=' text-blue-500 hover:underline '>Bishal Shrestha</Link> aka <Link  target='_blank' className=' text-blue-500 hover:underline ' href='https://github.com/iambstha'>@iambstha</Link></p>
